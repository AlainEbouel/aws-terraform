...
# # All this alias need to be add to the ACM certificate
#   aliases = ["numerix-md.com", "demo.numerix-md.com", "www.numerix-md.com"]
...
#     # iam_certificate_id = aws_acm_certificate.demo-tls-cert.id 
...
#   subject_alternative_names=["demo.numerix-md.com", "www.numerix-md.com"]
